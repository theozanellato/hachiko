...
#ifndef HACHIKOIMGUI_H
#define HACHIKOIMGUI_H
...
#define hachiko_force_inline __attribute__((always_inline)) inline
...
*/
[[maybe_unused]] static hachiko_force_inline void DrawLine( ImDrawList* draw, const ImVec2& v1, const ImVec2& v2, uint32_t col, float thickness = 1.0f )
{
    const ImVec2 data[2] = { v1, v2 };
    draw->AddPolyline( data, 2, col, 0, thickness );
}

[[maybe_unused]] static hachiko_force_inline void DrawLine( ImDrawList* draw, const ImVec2& v1, const ImVec2& v2, const ImVec2& v3, uint32_t col, float thickness = 1.0f )
{
    const ImVec2 data[3] = { v1, v2, v3 };
    draw->AddPolyline( data, 3, col, 0, thickness );
}
/*
[[maybe_unused]] static hachiko_force_inline void TooltipIfHovered( const char* text )
{
...
[[maybe_unused]] void hachiko_force_inline DrawHelpMarker( const char* desc )
{
